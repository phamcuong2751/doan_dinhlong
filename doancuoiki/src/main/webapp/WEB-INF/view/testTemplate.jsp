...
>
  ...
  <!-- Core CSS -->
  <link rel="stylesheet" href="<c:url value="/resources/assets/vendor/css/core.css" />" class="template-customizer-core-css" />
  <link rel="stylesheet" href="<c:url value="/resources/assets/vendor/css/theme-default.css" />" class="template-customizer-theme-css" />
  <link rel="stylesheet" href="<c:url value="/resources/assets/css/demo.css" />" />

  <!-- Vendors CSS -->
  <link rel="stylesheet" href="<c:url value="/resources/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />" />

  <link rel="stylesheet" href="<c:url value="/resources/assets/vendor/libs/apex-charts/apex-charts.css" />" />
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
          <a href="#" target="" class="menu-link" >
            <i class="menu-icon tf-icons bx bx-file"></i>
            <div data-i18n="Categories Management">Categories Management</div>
          </a>
        </li>
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <div class="row">
            <!-- Total Revenue -->
            <div class="col-12 order-2 order-md-3 mb-4">
              <div class="card">
        ...
        <script src="<c:url value="/resources/assets/vendor/js/bootstrap.js" />"></script>
          <script src="<c:url value="/resources/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js" />"></script>
            ...
            <script src="<c:url value="/resources/assets/vendor/js/menu.js" />"></script>
              ...
              <!-- Vendors JS -->
              <script src="<c:url value="/resources/assets/vendor/libs/apex-charts/apexcharts.js" />"></script>

                <!-- Main JS -->
                <script src="<c:url value="/resources/assets/js/main.js" />"></script>

                  <!-- Page JS -->
                  <script src="<c:url value="/resources/assets/js/dashboards-analytics.js" />"></script>
